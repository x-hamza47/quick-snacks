...
(async function () {
  ...
  try {
    ...
    if (category) {
      ...
      recipes = getRandomRecipes(recipes, 6);
    }
    ...
    recipes.forEach((recipe) => {
      ...
      let recipe_card = `
                   <div class="card recipe-card" style="width: 18rem;" data-id="${
                     recipe.id
                    ...
                    <div class="card-body text-center d-flex flex-column justify-content-between">
                        <small class="cat-title" style="text-transform:capitalize;">${recipe.category.replace(
                          /-/g,
                          " "
                        )}</small>
                        <h5 class="card-title">${
      ...
      card_container[0].innerHTML += recipe_card;
      card_container[1].innerHTML += recipe_card;
    });
  } catch (err) {
...
card_container.forEach((container) => {
